    ...
    static {
        taskTemplates = new TaskTemplate[] {
                ...
                builder()
                        ...
                        .minLevel(8)
                        .npcTalk(
                                "Chuyến đi lần này hơi khó khăn ta hi vọng con có thể làm tốt và quay về nếu chết có người khiêng con về nên cứ yên tâm")
                ...
                builder()
                        ...
                        .minLevel(22)
                        .npcTalk(
                                "Để trở thành một nhẫn giả thành công con phải trải qua quá trình rèn luyện mài dũa con hãy đi luyện tập đi để được khoẻ như ta")
                ...
                builder()
                        ...
                        .minLevel(25)
                        .npcTalk(
                                "Ta có đứa cháu do nó mãi ham chơi mà quên mất lối về con có thể giúp già này đi tìm nó về để già vổ mông nó không ?")
                        .npcMenu(new String[] {
                                "",
                                "Dẫn em về với",
                                "Hoàn thành nhiệm vụ"
                ...
                builder()
                        ...
                        .minLevel(26)
                        .npcTalk(
                                "Thuốc kia con mang về chưa đủ làng ta nước nhiều nhưng toàn nước mặn không thích hợp làm thuốc bôi vào vết thương rất là rát nên con hay lấy 1 ít nước ngọt về giúp ta nhé")
                        .receiveItems(new int[][] {
                                { 219, 100 },
                                {},
                                {}
                ...
                builder()
                        ...
                        .minLevel(28)
                        .npcTalk(
                                "Ta muốn phạt thằng Jain đi chẻ củi tội đi chơi mà quên đường về mà khổ nổi con heo nó cướp mất cái rìu rồi con hãy giúp ta tìm về để phạt thằng Jain nhé")
                ...
                builder()
                        ...
                        .npcTalk(
                                "Khi đi vào rừng ta có đánh rơi khoảng 100 cái chìa khoá nhỏ để đúc thành 1 cái chìa khoá lớn mở kho báu ta phải tìm đủ số lượng chìa khoá")
                        .itemsPick(new int[] {
                                -1,
                                230,
                                -1
                ...
                builder()
                        ...
                        .rewards(new int[][] {
                                ...
                                { XU_ID, 500_000 }, })
                        .npcTalk(
                                "Sao con không giữ tấm bảng đồ để đi tìm báu vật, thôi lỡ rồi ta giao lại cho con để đi tìm báu vật nhé, cứ đi theo tấm bản đồ là tìm được, "
                ...
                builder()
                        ...
                        .minLevel(38)
                        .npcTalk(
                                "Trời dạo này hơi nóng, con có thể giúp ta tìm một ít tinh thể băng về làm nước đá uống không")
                        .itemsPick(new int[] {
                                -1, 236, -1
                        })
                ...
                builder()
                        ...
                        .minLevel(45)
                        .npcTalk(
                                "Khá lắm trình độ của con là tốt hơn rồi, con hãy giúp dân làng tích trữ lương thực cho mùa đông nhé")
                        .mobs(new int[][] {
                                {},
                                { 47, 0 },
                                { 48, 0 },
                ...
                builder()
                        ...
                        .minLevel(51)
                        .npcTalk(
                                "Làng ta ma bao vây, chúng nó quấy phá làm làng ta không thể nào yên bình con có thể giúp ta diệt trừ chúng không ?")
                        .mobs(new int[][] {
                                {},
                                { 51, 0 },
                                { 52, 0 },
                ...
                builder()
                        ...
                        .minLevel(53)
                        .npcTalk(
                                "Ta muốn chiêu đãi con đặc sản làng ta nhưng mà nguyên liệu lại hết. Ta thì chân đang đau, con có thể giúp ta hái 1 ít nấm về chế biến món ăn không ?")
                        .itemsPick(new int[] {
                                -1, 347, -1
                ...
                builder()
                        ...
                        .minLevel(55)
                        .npcTalk(
                                "Ngôi làng chuẩn bị đóng một đợt hạn hán dài nguồn nước quanh làng đã sắp không trụ nổi con có thể giúp dân làng múc nước tích trữ không")
                ...
                builder()
                        ...
                        .minLevel(57)
                        .npcTalk(
                                "Ban đêm có những hồn ma lãng vãng quanh làng hù trẻ em và người già rất nhiều, không ít những người yếu bóng vía trở thành hồn ma do bị hù con có thể giúp ta thu thập hồn mà của họ về để ta làm lễ cho họ không")
                        .itemsPick(new int[] {
                                -1,
                                348,
                                -1
                ...
                builder()
                        ...
                        .minLevel(61)
                        .npcTalk(
                                "Sắp tới sinh nhật cô con gái bé bỏng của ta ta muốn tạo bất ngờ cho nó. Tuy nhiên ta để ý thấy ngươi hay nhìn trộm con gái của ta."
                ...
                builder()
                        ...
                        .minLevel(63)
                        .npcTalk(
                                "Sống gió phủ đời trai tương lai nhờ nhà vợ à câu này không đúng với nhà ta lắm. Nhà ta áp dụng câu không làm mà đòi ăn thì chỉ có ăn ... à mà thôi "
                ...
                builder()
                        ...
                        .minLevel(65)
                        .npcTalk(
                                "Sau khi cố gắng lao động mà không đủ ăn thì thử đen đỏ thử xem, hồi còn giàu ta cũng hay chơi mấy đồ yêu này lắm")
                ...
                builder()
                        ...
                        .minLevel(67)
                        .npcTalk(
                                "Bệnh thành tích là không tốt nhưng không có thành tích thì không ai nể thôi cố gắng lấy thành tích về đi bố vợ tưởng lai hứa sẽ gả con gái cho")
